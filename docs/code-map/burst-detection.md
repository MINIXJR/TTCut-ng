...
| `BURST → COL5` | **Setzt** Icon, Text und Tooltip — und **leert sie in allen Rückwegen**, wenn kein Burst vorliegt — auch im Kein-Audio-Ausstieg. |
...
- Spalte 5 wird nur über `updateHintColumn()` geschrieben. `updateBurstIcon` leert
  in **allen** Rückwegen Icon, Text und Tooltip — auch im Kein-Audio-Ausstieg.
